...
var StatisticDemo = function StatisticDemo(_ref) {
  ...
  var data2 = {
    ...
    items: [{
      ...
      chart: 'ColumnChain',
      title: '',
      rates: [{ name: '今日销售额', value: '18000' }, { name: '昨日销售额', value: '18800' }, { name: '同比下降', value: '3' }, { name: 'down', value: '%' }]
    }, {
      span: 1,
      chart: 'Num',
      title: '',
      rates: [{ name: '本月订单总数', value: '3213' }, { name: '同比上周', value: '-72' }]
    }]
  };
  ...
  var statisticProps = (0, _extends3.default)({}, data5);

  var props2 = (0, _extends3.default)({}, data2);
  ...
  return React.createElement(
    ...
    React.createElement(_statistic2.default, statisticProps)
  );
};

exports.default = StatisticDemo;