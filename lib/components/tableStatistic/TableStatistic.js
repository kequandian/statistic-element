...
export default function TableStatistic(props) {
  ...
  useEffect(_ => {
    if (Array.isArray(header) && Array.isArray(columns) && Array.isArray(rows)) {
      const tColumns = toFormatTableFields(formatColumns(header, columns, rows));
  ...
  return /*#__PURE__*/React.createElement("div", null, title ? /*#__PURE__*/React.createElement(Title, {
    level: 5
