import StatisticWrapped from "./Statistic"; // import NumberRows from '../numberRows/NumberRows';
// import ColumnTotal from '../columnTotal/ColumnTotal';

import ColumnChain from "./components/ColumnChain"; // import Pie from '../general-chart/Pie';
