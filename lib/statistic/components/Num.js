...
export default (({
  ...
  }, renderIcon(percentage), " ", rates[1].name || '-'));
});
...
function renderIcon(percentage) {
  ...
  if (increase) {
    ...
    }, /*#__PURE__*/React.createElement(CaretUpOutlined, null), " ", percentage, "%");
  }
  ...
  }, /*#__PURE__*/React.createElement(CaretDownOutlined, null), " ", percentage, "%");
}